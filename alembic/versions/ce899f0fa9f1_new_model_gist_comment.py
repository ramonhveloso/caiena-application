"""New model gist_comment

Revision ID: ce899f0fa9f1
Revises: e98fe0ea9953
Create Date: 2024-10-06 00:21:07.568637
...
revision: str = 'ce899f0fa9f1'
down_revision: Union[str, None] = 'e98fe0ea9953'
...
def upgrade() -> None:
    ...
    op.drop_index('ix_forecast_weather_city', table_name='forecast_weather')
...
def downgrade() -> None:
    ...
    sa.Column('current_temperature', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=False),
    sa.Column('feels_like', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=False),
    sa.Column('temp_min', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=False),
    sa.Column('temp_max', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=False),
    ...
    sa.Column('wind_gust', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True),
    sa.Column('cloudiness', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('weather_description', sa.VARCHAR(), autoincrement=False, nullable=False),
    sa.Column('observation_datetime', postgresql.TIMESTAMP(), autoincrement=False, nullable=False),
    sa.Column('sunrise', postgresql.TIMESTAMP(), autoincrement=False, nullable=False),
    sa.Column('sunset', postgresql.TIMESTAMP(), autoincrement=False, nullable=False),
    sa.Column('user_id', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name='current_weather_user_id_fkey'),
    ...
    op.create_index('ix_current_weather_city', 'current_weather', ['city'], unique=False)
    op.create_table('forecast_weather',
    sa.Column('id', sa.INTEGER(), autoincrement=True, nullable=False),
    sa.Column('city', sa.VARCHAR(), autoincrement=False, nullable=False),
    sa.Column('latitude', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=False),
    sa.Column('longitude', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=False),
    sa.Column('date', postgresql.TIMESTAMP(), autoincrement=False, nullable=False),
    sa.Column('average_temperature', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=False),
    sa.Column('min_temperature', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=False),
    sa.Column('max_temperature', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=False),
    sa.Column('weather_description', sa.VARCHAR(), autoincrement=False, nullable=False),
    ...
    sa.Column('user_id', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name='forecast_weather_user_id_fkey'),
    ...
    op.create_index('ix_forecast_weather_city', 'forecast_weather', ['city'], unique=False)
